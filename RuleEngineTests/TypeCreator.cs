    ...
    public class MetricDashboardType
    {
        ...
        public class TypeCreator
        {
            ...
            public static Type CreateNewType(string newTypeName, Dictionary<string, Type> dict, Type baseClassType)
            {
                ...
                AssemblyBuilder assemblyBldr = null; // AppDomain.CurrentDomain.din new AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("tmpAssembly"), AssemblyBuilderAccess.Run); //Thread.GetDomain(). .DefineDynamicAssembly(new AssemblyName("tmpAssembly"), AssemblyBuilderAccess.Run);
